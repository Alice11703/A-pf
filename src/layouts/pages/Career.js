    ...
    return (
        <>
            <div className="sc__content">
                ...
                <div className="career__cont">
                    ...
                    <div className="career__detail">
                        ...
                        <div className="career__desc">
                            ...
                            - 프로젝트 개발 및 유지보수<br />
                            - 협업 도구: TFS, Figma, Teams<br />
                            <p>UI/UX 퍼블리싱 contribution : 100%</p>
                            ...
                            - 협업 도구: Github, Notion, Jira, Slack<br />
                            <p>UI/UX 퍼블리싱 contribution : 50%</p>
                            ...
                            - 프로젝트 개발 및 유지보수<br />
                            협업 도구: Jira, Teams<br />
                            <p>UI/UX 디자인 및 퍼블리싱 contribution : 100%</p>
                        </div>
                ...
                <div className="career__cont">
                    <div className="career__logo">
                        <img alt="calyx_logo" src={CoopLogoImage} />
                    </div>
                    <div className="career__detail">
                        <div className="career__title">
                            <span>쿠프마케팅</span>
                ...
                <div className="career__cont">
                    <div className="career__logo">
                        <img alt="calyx_logo" src={ELLogoImage} />
                    </div>
                    <div className="career__detail">
                        <div className="career__title">
